...
struct IndicatorModel: Identifiable{
    let id: UUID
    var title: String
    var description: String
    var listName: Array = pupilLists
}

let indicatorLists: [IndicatorModel] = [
    IndicatorModel(id: UUID(), title: "Pupil", description: "Pupil kucing merupakan salah satu indikator yang dapat diobservasi untuk mengetahui kebutuhan kucing.", listName: pupilLists),

    IndicatorModel(id: UUID(), title: "Ekor", description: "Ekor kucing merupakan salah satu indikator yang dapat diobservasi untuk mengetahui kebutuhan kucing.", listName: ekorLists),
    
    IndicatorModel(id: UUID(), title: "Telinga", description: "Telinga kucing merupakan salah satu indikator yang dapat diobservasi untuk mengetahui kebutuhan kucing.", listName: telingaLists),
    
    IndicatorModel(id: UUID(), title: "Suara", description: "Suara kucing merupakan salah satu indikator yang dapat diobservasi untuk mengetahui kebutuhan kucing.", listName: suaraLists),
    
    IndicatorModel(id: UUID(), title: "Bentuk Badan", description: "Bentuk badan kucing merupakan salah satu indikator yang dapat diobservasi untuk mengetahui kebutuhan kucing.", listName: bentukBadanLists)
]
